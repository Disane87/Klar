...
**Sofort blocken:** `TODO`/`FIXME`/`// stub`/`// placeholder` im Commit · `as any` auf Prisma · Click-Handler die nichts tun · Migration ohne Schema-Model · Endpoint ohne Swagger-Annotation · Inline-Body-Interface statt DTO-Klasse.
