  ...
  template: `
    <brn-popover #popover="brnPopover" [sideOffset]="4" align="start">
      <button
        ...
        class="flex h-10 w-full items-center justify-between gap-2 rounded-md border border-(--border) bg-(--surface) px-3 text-sm scheme-dark transition-colors hover:bg-(--surface-2) disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-2 focus:ring-accent/40"
      >
